...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   SEARCH MODAL â€” same Spotlight pattern, teacher nav
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
const SearchModal = ({ isOpen, onClose, onAction }) => {
  ...
  const allItems = useMemo(() => {
    ...
    items.push(
      { label: 'Mark today\'s attendance', icon: 'check',    path: '/teacher-timetable', category: 'Actions' },
      { label: 'Log a session',            icon: 'log',      path: '/log-session',       category: 'Actions' },
      { label: 'Update syllabus',          icon: 'edit',     path: '/manage-syllabus',   category: 'Actions' },
      { label: 'View grading queue',       icon: 'grade',    path: '/grading',           category: 'Actions' },
    );
    return items;
  }, []);
